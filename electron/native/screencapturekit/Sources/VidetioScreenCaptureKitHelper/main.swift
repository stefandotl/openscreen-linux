...
final class ScreenCaptureRecorder: NSObject, SCStreamOutput, SCStreamDelegate {
	...
	private let sampleQueue = DispatchQueue(label: "app.videtio.sck-helper.samples")
	private let stateQueue = DispatchQueue(label: "app.videtio.sck-helper.state")
...
@main
struct VidetioScreenCaptureKitHelper {
